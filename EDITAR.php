...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Lorem Ipsum Inc., CADASTRAR/EDITAR">
...
<body class="u-body">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-0bdc">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h2 class="u-text u-text-1">CADASTRAR NOVO PROJETO</h2>
            <?php
    ...
    ?>
    <style>
     .nome{width: 50%; justify-content: left; max-width: 200px;}
     .datainicio{width: 100%; justify-content: left; max-width: 225px;}
     .datafim{width: 100%; justify-content: left; max-width: 253px;}
     .valorprojeto{width: 100%; justify-content: left; max-width: 200px;}
     .risco{width: 100%; justify-content: left; max-width: 270px;}
     .participantes{width: 100%; justify-content: left; max-width: 218px;}
    </style>
                <div class="u-form">
                <form method="POST" action="processa.php">
			<label><br><br>Nome do Projeto: </label>
			<input class="nome" type="text" name="nomeprojeto" placeholder="nome do projeto"><br><br>
			
			<label>Data de inicio: </label>
			<input class="datainicio" type="date" name="datainicio" placeholder="informe data (ex: 00/00/2000)"><br><br>

			<label>Data final: </label>
			<input class="datafim" type="date" name="datafim" placeholder="informe data (ex: 00/00/2000)"><br><br>

            <label>Valor do projeto </label>
			<input class="valorprojeto" id="valorprojeto" type="number" name="valorprojeto" placeholder="informe o valor do projeto"><br><br>

            <label>Risco: </label>
			<input class="risco" id="risco" type="number" name="risco" placeholder=" Risco ( 0 - baixo, 1 - medio, 2- alto )"><br><br>

            <label>Participantes: </label>
			<input class="participantes" type="text" name="participantes" placeholder="informar participantes"><br><br>
    ...
    function showPrompt() {
        //var risco = alert(document.getElementById("risco").value);
        ...
        var valordigitado = parseInt(prompt("Informe o valor do investimento", ""));
        if ( valordigitado < valorprojeto) {
    alert( "O valor do investimento é menor que o valor do projeto ");
  } else if (risco == 0){
      alert("Retorno de 5% do valor do seu investimento: " + (valordigitado*5)/100);
  }else if (risco == 1){
      alert("Retorno de 10% do valor do seu investimento: " + (valordigitado*10)/100);
  }else if (risco ==2){
      alert("Retorno de 20% do valor do seu investimento: " + (valordigitado*20)/100);
  }
...
<button class="botao" type="button" onClick="showPrompt();">SIMULAR INVESTIMENTO</button>
</body>         
        <a href="#" class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-3" onclick="location.href='index.php'">PAGINA INICIAL</a>
        </div>
    </section>
</body>
</html>